...
function fitSettings = optimizeFittingParameters(otherCellLines, funToFit)
...
for cellLineIter = 1:numberCellLines
    ...
    for comboIter = 1:size(uregCombos,1)
        ...
        %for span_iter = 1:length(spans)
            ...
            MPE_cl = zeros(1,c_part.NumTestSets);
            
            for trainingIter = 1:c_part.NumTestSets
                
                % collect Training Data
                ioi_train = c_part.training(trainingIter);
                ...
                % collect Test Data
                ioi_test = c_part.test(trainingIter);
                ...
                MPE_cl(trainingIter) = calculate_MeanPercentError(...
